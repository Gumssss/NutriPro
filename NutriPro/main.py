...
def food_vision_agent(state: AgentState):
    ...
    message = HumanMessage(
        content=[
            {
                "type": "text", 
                "text": "Identify all raw food ingredients in this image. Estimate the calories for the quantities shown. Return ONLY a JSON object with keys 'ingredients' (list) and 'total_base_calories' (number)."
            },
            {
                "type": "image_url",
